...
gen_enforced_field(WorkspaceCwd, 'repository.type', 'git') :-
  \+ workspace_field(WorkspaceCwd, 'private', true).
gen_enforced_field(WorkspaceCwd, 'repository.url', 'https://github.com/sbonami/milliejs.git') :-
  \+ workspace_field(WorkspaceCwd, 'private', true).
...
% Enforces 'bugs.url' is set for public workspaces while removing it from private workspaces
gen_enforced_field(WorkspaceCwd, 'bugs.url', 'https://github.com/sbonami/milliejs/issues') :-
  \+ workspace_field(WorkspaceCwd, 'private', true).
